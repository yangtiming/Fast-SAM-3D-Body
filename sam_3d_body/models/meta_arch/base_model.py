...
class BaseModel(BaseLightningModule):
    ...
    def _set_fp16(self, module, fp16_type):
        # Skip FP16 conversion for TensorRT backbone (already optimized)
        if hasattr(module, "_use_tensorrt") and module._use_tensorrt:
            return
        ...
        elif hasattr(module, "encoder") and hasattr(module.encoder, "rope_embed"):
            # DINOv3
        ...
        elif hasattr(module, "encoder") and hasattr(module.encoder, "pos_embed"):
            # DINOv2
